...
- [x] Measure CI time impact of the disk-derived `-count=1` module loops; tune if it dominates the job (23:47 f49; .github/workflows/ci.yml) — DONE 2026-09-10: measured from green run 34406684629 step timings (gh api): test job 26s/271s (~10%), test-windows 39s/173s (~23%); neither dominates (Test step itself 82-89s, lint 84s), and setup-go's build cache already amortizes the per-module compiles — no tuning warranted
