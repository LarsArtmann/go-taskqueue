...
| 32 | ⚠ heredoc-append + `| tail` crush-hook warnings (§e9 of 01-34; both rules keep being re-violated under momentum — including batched-verify momentum)                          | Medium | S | DX |
...
*Report by the dedup continuation window (02:35). Gates cited in §a10 are
