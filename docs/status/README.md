...
| 2026-09-07 | see `docs/planning/` round-4 plan and its referenced reports | Dogfood pool round |
| 2026-09-07 | `2026-09-07_16-25_*` round-3 series (in planning/) | Live web UI build-out |
| 2026-09-06 | `2026-09-06_19-49_round2-complete-*`, `18-34_*`, `18-00_*`, `16-19_*` | Round 2: release v0.1.0 + hardening + docs audit |

Earlier sessions (2026-09-05/06, round 1) live in `docs/planning/`
alongside their plans; the round-2 report series above is where the
report convention stabilized.
