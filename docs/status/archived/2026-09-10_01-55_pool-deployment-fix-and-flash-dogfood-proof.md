...
> **ARCHIVED 2026-09-21 (docs-health archive sweep)** — every forward-looking item verified resolved at HEAD (per-item triage): poolSettings proposal routed (TODO SystemNix pool validation), owner flip+deploy routed (TODO row 21), backend-tag proxy checks routed (TODO row 25); no numbered forward list. No open residue.
