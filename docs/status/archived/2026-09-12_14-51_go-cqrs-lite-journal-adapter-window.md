...
_(Archived 2026-09-13 docs-health pass: adapter shipped (internal/journal/cqrs, ADR-0014); the 2026-09-13 cqrs-lint window found and fixed the encoding bug this window shipped — both reports now historical. Point-in-time snapshot — re-verify before treating any claim as current.)_
