...
> **ARCHIVED 2026-09-21 (docs-health archive sweep)** — every forward-looking item verified resolved at HEAD (per-item triage): all follow-ups routed to the Webui-overhaul-leftovers TODO rows (Pagination/ListNote/errorpage/MaxTicks done; sort-chip + CSP rows own the remainder). No open residue.

**Task window:** owner GO on `docs/planning/archived/2026-09-14_13-24_ui-stunning-overhaul.md`;
