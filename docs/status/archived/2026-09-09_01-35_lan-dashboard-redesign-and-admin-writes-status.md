...
_Format override: `.md` per explicit instruction (skill default is HTML). Point-in-time snapshot — annotate, don't rewrite. Compares against `docs/status/2026-09-08_22-42_fleet-onboarding-agent-pool-integration-status.md`._
