...
> **ARCHIVED 2026-09-21 (docs-health archive sweep)** — every forward-looking item verified resolved at HEAD (per-item triage): §f minted verbatim as TODO rows 276-305 (this report IS the harvest); every item routed. No open residue.
