...
_(Archived 2026-09-13 docs-health pass: five tasks verified done; the NOT-STARTED list was harvested to TODO_LIST and the docs-health continuation is itself now done (this 2026-09-13 archive sweep). Point-in-time snapshot — re-verify before treating any claim as current.)_
