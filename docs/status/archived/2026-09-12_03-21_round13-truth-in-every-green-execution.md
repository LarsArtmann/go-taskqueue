...
_(Archived 2026-09-13 docs-health pass: T1-T8 + T14/T15/T17 all landed and runner-proven (green master runs since); remaining items were ruling-gated and live in TODO_LIST. Point-in-time snapshot — re-verify before treating any claim as current.)_
