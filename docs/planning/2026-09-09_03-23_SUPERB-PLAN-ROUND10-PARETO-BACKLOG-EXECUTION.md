...
_Point-in-time plan. When tasks complete, close them in TODO_LIST.md (the living source) and record evidence in CHANGELOG.md; bring THIS file current only via docs-health ANNOTATE (strikethroughs), never rewrites._
