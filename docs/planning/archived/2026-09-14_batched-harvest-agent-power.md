...
> **EXECUTED — ARCHIVED 2026-09-21 (docs-health archive sweep)** — shipped (Config.BatchItems, DefaultBatchPromptTemplate, --batch-items, batch_test.go, FEATURES row); live-pool dogfood rides the deploy-cadence BLOCKED rows.
