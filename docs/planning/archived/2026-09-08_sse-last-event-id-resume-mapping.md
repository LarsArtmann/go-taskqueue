...
> **EXECUTED — ARCHIVED 2026-09-21 (docs-health archive sweep)** — contract consumed; §4 bug fixed (app.js forwards filter); §7 checklist struck done 2026-09-11; dispatcher half lives in the BLOCKED TODO row.
...
watermarks").
**Companion docs:**
`docs/planning/archived/2026-09-08_journal-subscription-surface-inventory.md` (§2 row 3
