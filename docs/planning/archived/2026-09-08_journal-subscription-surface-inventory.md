...
> **EXECUTED — ARCHIVED 2026-09-21 (docs-health archive sweep)** — surface shipped (internal/consumer, ADR-0009); dispatcher-wiring decision routed as BLOCKED TODO row; in-doc annotations current.
