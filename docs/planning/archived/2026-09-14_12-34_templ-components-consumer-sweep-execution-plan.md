...
> **EXECUTED — ARCHIVED 2026-09-21 (docs-health archive sweep)** — ADR-0018 decided; tq enqueue --dedup-key shipped; fanout-libdive.sh + cohort TSV live; UX residue routed (swap-guard row 207, MaxTicks row 247).
