...
> **EXECUTED — ARCHIVED 2026-09-21 (docs-health archive sweep)** — DESIGN → IMPLEMENTED (internal/executor/dlqfix.go + internal/dlqfix, DismissDead/RescueDead both backends, conformance + replay pins, --dlq-fix flag); usage-field gap routed row 202.
