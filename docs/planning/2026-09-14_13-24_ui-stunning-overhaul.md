...
*Plan written 2026-09-14 13:24 CEST from the 2026-09-14 audit evidence. Format note:
skill default is styled HTML; user explicitly requested .md + mermaid — override honored.*
